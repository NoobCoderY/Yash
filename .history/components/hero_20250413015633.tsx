...
export default function Hero() {
  return (
    <section id="home" className="min-h-screen flex flex-col justify-center pt-16 pb-12 relative overflow-hidden">
      {/* Background elements */}
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center relative z-10">
        ...
        >
          ...
          <p className="text-lg text-gray-400 mb-8 max-w-xl">
            Specialized in building robust web applications with React, Node.js, and AWS. Passionate about creating
          ...
          <div className="flex flex-wrap gap-4 mb-8">
            ...
            <Link href="#projects">
              <Button variant="outline" size="lg" className="rounded-full border-gray-700 hover:bg-gray-800/50">
                View Projects
              </Button>
            </Link>
          </div>
              ...
              <div className="animate-float">
                <div className="text-center p-8">
                  ...
                  <div className="flex justify-center space-x-2">
                    ...
                    <span className="px-3 py-1 bg-gray-800 rounded-full text-xs text-gray-300">AWS</span>
                  </div>
                </div>
              </div>
            </div>
      ...
      >
        <Link href="#about">
          <Button variant="ghost" size="icon" className="rounded-full animate-bounce" aria-label="Scroll down">
            <ArrowDown size={20} />
          </Button>
        </Link>
      </motion.div>
