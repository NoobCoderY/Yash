...
export default function Projects() {
  ...
  const projects = [
    ...
    },
    {
      ...
      description:
        'A React-based cryptocurrency tracking application featuring live data charts, favorite coin management, and real-time price updates. Users can track market trends and set price alerts.',
      image: '/placeholder.svg?height=300&width=500',
      tags: [
        'React.js',
        'Redux',
    ...
    },
    {
      ...
      description:
        'A comprehensive admin dashboard for managing e-commerce orders, products, and customer data. Features include sales analytics, inventory management, and order processing.',
      image: '/placeholder.svg?height=300&width=500',
      tags: [
        'MongoDB',
        'Express.js',
