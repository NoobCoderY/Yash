          ...
          >
            ...
            >
              {filteredProjects.map((project, i) => (
                ...
                >
                  <Card className='h-[320px] bg-gradient-to-br z-[1] from-gray-900/90 to-gray-800/80 border-gray-800 hover:border-primary/40 transition-all duration-300 overflow-hidden group relative'>
